...
const Gallery = () => {
    ...
    const galleryImages = [
        ...
        { id: 7, src: '/images/gallery/image (7).webp', alt: 'Granite design 1', category: "Marble" },
        { id: 8, src: '/images/gallery/image (8).webp', alt: 'Granite design 2', category: "Marble" },
        { id: 9, src: '/images/gallery/image (9).webp', alt: 'Marble installation', category: "Installation" },
        { id: 10, src: '/images/gallery/image (10).webp', alt: 'Marble installation', category: "Granite" },
    ]
